...
AZURE_IMPROVE_PROMPT_BUTTON_COLOR = os.environ.get("AZURE_IMPROVE_PROMPT_BUTTON_COLOR") or "#3498db"
AZURE_LOGO_BORDER_RADIUS = os.environ.get("AZURE_LOGO_BORDER_RADIUS") or "0"
...
def get_config():
    config_data = {
        ...
        "AZURE_IMPROVE_PROMPT_BUTTON_COLOR": AZURE_IMPROVE_PROMPT_BUTTON_COLOR,
